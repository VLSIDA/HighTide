...
create_clock -name $clk_name  -period 2500  -waveform {0 1250}  $clk_port
...
create_clock -name $clk_falcon_name  -period 3500  -waveform {0 1750}  $clk_falcon_port
...
set_input_delay [expr 3500 * $clk_io_pct] -clock $clk_name $non_clock_inputs
set_output_delay [expr 3500 * $clk_io_pct] -clock $clk_name [all_outputs]
