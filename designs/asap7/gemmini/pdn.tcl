...
add_pdn_stripe -grid {top} -layer {M7} -width {0.416} -spacing {0.10}  -pitch {4.0} -offset {0.500}
add_pdn_stripe -grid {top} -layer {M8} -width {0.40}  -spacing {0.10}  -pitch {4.0} -offset {0.500}
add_pdn_stripe -grid {top} -layer {M9} -width {0.80}  -spacing {0.20}  -pitch {8.0} -offset {1.000}
