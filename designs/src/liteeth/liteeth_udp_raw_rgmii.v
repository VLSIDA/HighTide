...
module liteeth_udp_raw_rgmii (
    ...
    input  wire          raw_sink_last,
    input  wire    [3:0] raw_sink_last_be,
    input  wire   [15:0] raw_sink_length,
    output wire          raw_sink_ready,
    input  wire   [15:0] raw_sink_src_port,
    input  wire          raw_sink_valid,
    output wire   [31:0] raw_source_data,
    output wire   [15:0] raw_source_dst_port,
    output wire          raw_source_error,
    output wire   [31:0] raw_source_ip_address,
    output wire          raw_source_last,
    output wire    [3:0] raw_source_last_be,
    output wire   [15:0] raw_source_length,
    input  wire          raw_source_ready,
    output wire   [15:0] raw_source_src_port,
    output wire          raw_source_valid,
    ...
    input  wire   [31:0] streamer1_ip_address,
    input  wire   [31:0] streamer1_sink_data,
    input  wire          streamer1_sink_last,
    output wire          streamer1_sink_ready,
    input  wire          streamer1_sink_valid,
    output wire   [31:0] streamer1_source_data,
    output wire          streamer1_source_error,
    output wire          streamer1_source_last,
    input  wire          streamer1_source_ready,
    output wire          streamer1_source_valid,
    input  wire   [15:0] streamer1_udp_port,
    input  wire   [31:0] streamer2_ip_address,
    input  wire   [31:0] streamer2_sink_data,
    input  wire          streamer2_sink_last,
    output wire          streamer2_sink_ready,
    input  wire          streamer2_sink_valid,
    output wire   [31:0] streamer2_source_data,
    output wire          streamer2_source_error,
    output wire          streamer2_source_last,
    input  wire          streamer2_source_ready,
    output wire          streamer2_source_valid,
    input  wire   [15:0] streamer2_udp_port,
...
wire          internal_port_sink_payload_last_be;
reg           internal_port_sink_ready = 1'd0;
...
reg     [7:0] internal_port_source_payload_data = 8'd0;
reg           internal_port_source_payload_error = 1'd0;
reg           internal_port_source_payload_last_be = 1'd0;
...
reg     [2:0] liteethudp_request = 3'd0;
reg     [2:0] liteethudp_sel0 = 3'd0;
reg     [2:0] liteethudp_sel1 = 3'd0;
reg     [2:0] liteethudp_sel_ongoing = 3'd0;
...
reg           liteethudp_status2_first = 1'd1;
wire          liteethudp_status2_last;
wire          liteethudp_status2_ongoing0;
reg           liteethudp_status2_ongoing1 = 1'd0;
...
reg    [15:0] liteethudpstreamer0_rx_udp_port = streamer1_udp_port;
...
reg    [31:0] liteethudpstreamer0_tx_ip_address0 = streamer1_ip_address;
...
reg    [15:0] liteethudpstreamer0_tx_udp_port0 = streamer1_udp_port;
...
reg    [15:0] liteethudpstreamer1_rx_udp_port = streamer2_udp_port;
...
reg    [31:0] liteethudpstreamer1_tx_ip_address0 = streamer2_ip_address;
...
reg    [15:0] liteethudpstreamer1_tx_udp_port0 = streamer2_udp_port;
...
wire    [4:0] mac_core_cdc_consume_wdomain;
reg    [11:0] mac_core_cdc_dout = 12'd0;
...
reg     [4:0] mac_core_cdc_graycounter0_q = 5'd0;
reg     [4:0] mac_core_cdc_graycounter0_q_binary = 5'd0;
wire    [4:0] mac_core_cdc_graycounter0_q_next;
reg     [4:0] mac_core_cdc_graycounter0_q_next_binary = 5'd0;
wire          mac_core_cdc_graycounter1_ce;
reg     [4:0] mac_core_cdc_graycounter1_q = 5'd0;
reg     [4:0] mac_core_cdc_graycounter1_q_binary = 5'd0;
wire    [4:0] mac_core_cdc_graycounter1_q_next;
reg     [4:0] mac_core_cdc_graycounter1_q_next_binary = 5'd0;
wire    [4:0] mac_core_cdc_produce_rdomain;
wire    [3:0] mac_core_cdc_rdport_adr;
wire   [11:0] mac_core_cdc_rdport_dat_r;
wire          mac_core_cdc_re;
reg           mac_core_cdc_readable = 1'd0;
...
wire    [3:0] mac_core_cdc_wrport_adr;
...
wire    [4:0] mac_core_txdatapath_cdc_consume_wdomain;
reg    [11:0] mac_core_txdatapath_cdc_dout = 12'd0;
...
reg     [4:0] mac_core_txdatapath_cdc_graycounter0_q = 5'd0;
reg     [4:0] mac_core_txdatapath_cdc_graycounter0_q_binary = 5'd0;
wire    [4:0] mac_core_txdatapath_cdc_graycounter0_q_next;
reg     [4:0] mac_core_txdatapath_cdc_graycounter0_q_next_binary = 5'd0;
wire          mac_core_txdatapath_cdc_graycounter1_ce;
reg     [4:0] mac_core_txdatapath_cdc_graycounter1_q = 5'd0;
reg     [4:0] mac_core_txdatapath_cdc_graycounter1_q_binary = 5'd0;
wire    [4:0] mac_core_txdatapath_cdc_graycounter1_q_next;
reg     [4:0] mac_core_txdatapath_cdc_graycounter1_q_next_binary = 5'd0;
wire    [4:0] mac_core_txdatapath_cdc_produce_rdomain;
wire    [3:0] mac_core_txdatapath_cdc_rdport_adr;
wire   [11:0] mac_core_txdatapath_cdc_rdport_dat_r;
wire          mac_core_txdatapath_cdc_re;
reg           mac_core_txdatapath_cdc_readable = 1'd0;
...
wire    [3:0] mac_core_txdatapath_cdc_wrport_adr;
...
reg     [4:0] multiregimpl50 = 5'd0;
reg     [4:0] multiregimpl51 = 5'd0;
reg     [4:0] multiregimpl60 = 5'd0;
reg     [4:0] multiregimpl61 = 5'd0;
wire          por_clk;
wire          re;
wire          rst10;
wire          rst11;
...
reg    [15:0] rx_converter_source_param_dst_port = 16'd0;
reg    [31:0] rx_converter_source_param_ip_address = 32'd0;
reg    [15:0] rx_converter_source_param_length = 16'd0;
reg    [15:0] rx_converter_source_param_src_port = 16'd0;
...
reg     [3:0] user_port_sink_payload_error = 4'd0;
...
assign user_port_sink_valid = raw_sink_valid;
assign user_port_sink_last = raw_sink_last;
assign user_port_sink_param_dst_port = raw_sink_dst_port;
assign user_port_sink_param_src_port = raw_sink_src_port;
assign user_port_sink_param_ip_address = raw_sink_ip_address;
assign user_port_sink_param_length = raw_sink_length;
assign raw_sink_ready = user_port_sink_ready;
assign user_port_sink_payload_data = raw_sink_data;
assign user_port_sink_payload_last_be = raw_sink_last_be;
assign raw_source_valid = user_port_source_valid;
assign raw_source_last = user_port_source_last;
assign raw_source_dst_port = user_port_source_param_dst_port;
assign raw_source_src_port = user_port_source_param_src_port;
assign raw_source_ip_address = user_port_source_param_ip_address;
assign raw_source_length = user_port_source_param_length;
assign user_port_source_ready = raw_source_ready;
assign raw_source_data = user_port_source_payload_data;
assign raw_source_last_be = user_port_source_payload_last_be;
assign raw_source_error = user_port_source_payload_error;
assign liteethudpstreamer0_tx_sink_sink_valid = streamer1_sink_valid;
assign liteethudpstreamer0_tx_sink_sink_last = streamer1_sink_last;
assign streamer1_sink_ready = liteethudpstreamer0_tx_sink_sink_ready;
assign liteethudpstreamer0_tx_sink_sink_payload_data = streamer1_sink_data;
assign streamer1_source_valid = liteethudpstreamer0_rx_source_source_valid;
assign streamer1_source_last = liteethudpstreamer0_rx_source_source_last;
assign liteethudpstreamer0_rx_source_source_ready = streamer1_source_ready;
assign streamer1_source_data = liteethudpstreamer0_rx_source_source_payload_data;
assign streamer1_source_error = liteethudpstreamer0_rx_source_source_payload_error;
assign liteethudpstreamer1_tx_sink_sink_valid = streamer2_sink_valid;
assign liteethudpstreamer1_tx_sink_sink_last = streamer2_sink_last;
assign streamer2_sink_ready = liteethudpstreamer1_tx_sink_sink_ready;
assign liteethudpstreamer1_tx_sink_sink_payload_data = streamer2_sink_data;
assign streamer2_source_valid = liteethudpstreamer1_rx_source_source_valid;
assign streamer2_source_last = liteethudpstreamer1_rx_source_source_last;
assign liteethudpstreamer1_rx_source_source_ready = streamer2_source_ready;
assign streamer2_source_data = liteethudpstreamer1_rx_source_source_payload_data;
assign streamer2_source_error = liteethudpstreamer1_rx_source_source_payload_error;
...
assign rgmii_rst_n = (~ethphy_reset);
...
assign {mac_core_txdatapath_cdc_fifo_out_last, mac_core_txdatapath_cdc_fifo_out_first, mac_core_txdatapath_cdc_fifo_out_payload_error, mac_core_txdatapath_cdc_fifo_out_payload_last_be, mac_core_txdatapath_cdc_fifo_out_payload_data} = mac_core_txdatapath_cdc_dout;
...
assign mac_core_txdatapath_cdc_source_valid = mac_core_txdatapath_cdc_readable;
...
assign mac_core_txdatapath_cdc_re = mac_core_txdatapath_cdc_source_ready;
assign mac_core_txdatapath_cdc_asyncfifo_re = (mac_core_txdatapath_cdc_re | (~mac_core_txdatapath_cdc_readable));
...
assign mac_core_txdatapath_cdc_asyncfifo_writable = (((mac_core_txdatapath_cdc_graycounter0_q[4] == mac_core_txdatapath_cdc_consume_wdomain[4]) | (mac_core_txdatapath_cdc_graycounter0_q[3] == mac_core_txdatapath_cdc_consume_wdomain[3])) | (mac_core_txdatapath_cdc_graycounter0_q[2:0] != mac_core_txdatapath_cdc_consume_wdomain[2:0]));
...
assign mac_core_txdatapath_cdc_wrport_adr = mac_core_txdatapath_cdc_graycounter0_q_binary[3:0];
...
assign mac_core_txdatapath_cdc_rdport_adr = mac_core_txdatapath_cdc_graycounter1_q_next_binary[3:0];
assign mac_core_txdatapath_cdc_asyncfifo_dout = mac_core_txdatapath_cdc_rdport_dat_r;
always @(*) begin
    mac_core_txdatapath_cdc_graycounter0_q_next_binary <= 5'd0;
...
assign mac_core_txdatapath_cdc_graycounter0_q_next = (mac_core_txdatapath_cdc_graycounter0_q_next_binary ^ mac_core_txdatapath_cdc_graycounter0_q_next_binary[4:1]);
always @(*) begin
    mac_core_txdatapath_cdc_graycounter1_q_next_binary <= 5'd0;
...
assign mac_core_txdatapath_cdc_graycounter1_q_next = (mac_core_txdatapath_cdc_graycounter1_q_next_binary ^ mac_core_txdatapath_cdc_graycounter1_q_next_binary[4:1]);
...
assign {mac_core_cdc_fifo_out_last, mac_core_cdc_fifo_out_first, mac_core_cdc_fifo_out_payload_error, mac_core_cdc_fifo_out_payload_last_be, mac_core_cdc_fifo_out_payload_data} = mac_core_cdc_dout;
...
assign mac_core_cdc_source_valid = mac_core_cdc_readable;
...
assign mac_core_cdc_re = mac_core_cdc_source_ready;
assign mac_core_cdc_asyncfifo_re = (mac_core_cdc_re | (~mac_core_cdc_readable));
...
assign mac_core_cdc_asyncfifo_writable = (((mac_core_cdc_graycounter0_q[4] == mac_core_cdc_consume_wdomain[4]) | (mac_core_cdc_graycounter0_q[3] == mac_core_cdc_consume_wdomain[3])) | (mac_core_cdc_graycounter0_q[2:0] != mac_core_cdc_consume_wdomain[2:0]));
assign mac_core_cdc_asyncfifo_readable = (mac_core_cdc_graycounter1_q != mac_core_cdc_produce_rdomain);
assign mac_core_cdc_wrport_adr = mac_core_cdc_graycounter0_q_binary[3:0];
assign mac_core_cdc_wrport_dat_w = mac_core_cdc_asyncfifo_din;
assign mac_core_cdc_wrport_we = mac_core_cdc_graycounter0_ce;
assign mac_core_cdc_rdport_adr = mac_core_cdc_graycounter1_q_next_binary[3:0];
assign mac_core_cdc_asyncfifo_dout = mac_core_cdc_rdport_dat_r;
always @(*) begin
    mac_core_cdc_graycounter0_q_next_binary <= 5'd0;
...
assign mac_core_cdc_graycounter0_q_next = (mac_core_cdc_graycounter0_q_next_binary ^ mac_core_cdc_graycounter0_q_next_binary[4:1]);
always @(*) begin
    mac_core_cdc_graycounter1_q_next_binary <= 5'd0;
...
assign mac_core_cdc_graycounter1_q_next = (mac_core_cdc_graycounter1_q_next_binary ^ mac_core_cdc_graycounter1_q_next_binary[4:1]);
assign mac_core_rx_preamble_sink_valid = ethphy_source_valid;
assign ethphy_source_ready = mac_core_rx_preamble_sink_ready;
assign mac_core_rx_preamble_sink_first = ethphy_source_first;
assign mac_core_rx_preamble_sink_last = ethphy_source_last;
assign mac_core_rx_preamble_sink_payload_data = ethphy_source_payload_data;
assign mac_core_rx_preamble_sink_payload_last_be = ethphy_source_payload_last_be;
assign mac_core_rx_preamble_sink_payload_error = ethphy_source_payload_error;
...
assign arp_tx_packetizer_sink_param_sender_ip = 32'd2887647233;
...
assign ip_tx_packetizer_sink_param_sender_ip = 32'd2887647233;
    ...
    case (liteethip_liteethiprx_state)
        ...
        default: begin
            if ((ip_rx_depacketizer_source_valid & ip_rx_liteethipv4checksum_done)) begin
                ...
                if ((((((ip_rx_depacketizer_source_param_target_ip == 32'd2887647233) | 1'd1) & (ip_rx_depacketizer_source_param_version == 3'd4)) & (ip_rx_depacketizer_source_param_ihl == 3'd5)) & (ip_rx_liteethipv4checksum_value == 1'd0))) begin
...
always @(*) begin
    liteethudp_sel0 <= 3'd0;
    if ((crossbar_sink_param_dst_port == raw_sink_dst_port)) begin
        liteethudp_sel0 <= 1'd1;
    end
    if ((crossbar_sink_param_dst_port == streamer1_udp_port)) begin
        liteethudp_sel0 <= 2'd2;
    end
    if ((crossbar_sink_param_dst_port == streamer2_udp_port)) begin
        liteethudp_sel0 <= 3'd4;
    end
end
...
always @(*) begin
    ...
    internal_port_sink_ready <= 1'd0;
    liteethudpstreamer0_internal_port_sink_ready <= 1'd0;
    liteethudpstreamer1_internal_port_sink_ready <= 1'd0;
    case (liteethudp_grant)
        1'd0: begin
            crossbar_source_valid <= internal_port_sink_valid;
            internal_port_sink_ready <= crossbar_source_ready;
            crossbar_source_first <= internal_port_sink_first;
            crossbar_source_last <= internal_port_sink_last;
            crossbar_source_payload_data <= internal_port_sink_payload_data;
            crossbar_source_payload_last_be <= internal_port_sink_payload_last_be;
            crossbar_source_payload_error <= internal_port_sink_payload_error;
            crossbar_source_param_src_port <= internal_port_sink_param_src_port;
            crossbar_source_param_dst_port <= internal_port_sink_param_dst_port;
            crossbar_source_param_ip_address <= internal_port_sink_param_ip_address;
            crossbar_source_param_length <= internal_port_sink_param_length;
        end
        1'd1: begin
...
assign liteethudp_status0_last = ((internal_port_sink_valid & internal_port_sink_last) & internal_port_sink_ready);
assign liteethudp_status0_ongoing0 = ((internal_port_sink_valid | liteethudp_status0_ongoing1) & (~liteethudp_status0_last));
assign liteethudp_status1_last = ((liteethudpstreamer0_internal_port_sink_valid & liteethudpstreamer0_internal_port_sink_last) & liteethudpstreamer0_internal_port_sink_ready);
assign liteethudp_status1_ongoing0 = ((liteethudpstreamer0_internal_port_sink_valid | liteethudp_status1_ongoing1) & (~liteethudp_status1_last));
assign liteethudp_status2_last = ((liteethudpstreamer1_internal_port_sink_valid & liteethudpstreamer1_internal_port_sink_last) & liteethudpstreamer1_internal_port_sink_ready);
assign liteethudp_status2_ongoing0 = ((liteethudpstreamer1_internal_port_sink_valid | liteethudp_status2_ongoing1) & (~liteethudp_status2_last));
always @(*) begin
    liteethudp_sel1 <= 3'd0;
...
always @(*) begin
    ...
    internal_port_source_payload_data <= 8'd0;
    internal_port_source_payload_error <= 1'd0;
    internal_port_source_payload_last_be <= 1'd0;
...
assign mac_core_txdatapath_cdc_produce_rdomain = multiregimpl11;
assign mac_core_txdatapath_cdc_consume_wdomain = multiregimpl21;
assign mac_core_pulsesynchronizer0_toggle_o = multiregimpl31;
assign mac_core_pulsesynchronizer1_toggle_o = multiregimpl41;
assign mac_core_cdc_produce_rdomain = multiregimpl51;
assign mac_core_cdc_consume_wdomain = multiregimpl61;
...
always @(posedge eth_rx_clk) begin
    ...
    if (eth_rx_rst) begin
        ...
        mac_core_cdc_graycounter0_q <= 5'd0;
        mac_core_cdc_graycounter0_q_binary <= 5'd0;
        liteethmac_rxdatapath_liteethmacpreamblechecker_state <= 1'd0;
        liteethmac_rxdatapath_bufferizeendpoints_state <= 2'd0;
    end
    multiregimpl60 <= mac_core_cdc_graycounter1_q;
    multiregimpl61 <= multiregimpl60;
end

always @(posedge eth_tx_clk) begin
    if ((mac_core_txdatapath_cdc_re | (~mac_core_txdatapath_cdc_readable))) begin
        mac_core_txdatapath_cdc_dout <= mac_core_txdatapath_cdc_asyncfifo_dout;
        mac_core_txdatapath_cdc_readable <= mac_core_txdatapath_cdc_asyncfifo_readable;
    end
    ...
    if (eth_tx_rst) begin
        mac_core_txdatapath_cdc_readable <= 1'd0;
        mac_core_txdatapath_cdc_graycounter1_q <= 5'd0;
        mac_core_txdatapath_cdc_graycounter1_q_binary <= 5'd0;
    ...
    multiregimpl10 <= mac_core_txdatapath_cdc_graycounter0_q;
...
always @(posedge sys_clk) begin
    ...
    if ((mac_core_cdc_re | (~mac_core_cdc_readable))) begin
        mac_core_cdc_dout <= mac_core_cdc_asyncfifo_dout;
        mac_core_cdc_readable <= mac_core_cdc_asyncfifo_readable;
    end
    ...
    arp_rx_valid <= (((((arp_rx_depacketizer_source_valid & (arp_rx_depacketizer_source_param_hwtype == 1'd1)) & (arp_rx_depacketizer_source_param_proto == 12'd2048)) & (arp_rx_depacketizer_source_param_hwsize == 3'd6)) & (arp_rx_depacketizer_source_param_protosize == 3'd4)) & (arp_rx_depacketizer_source_param_target_ip == 32'd2887647233));
    ...
    rx_converter_source_param_src_port <= rx_converter_sink_param_src_port;
    rx_converter_source_param_dst_port <= rx_converter_sink_param_dst_port;
    rx_converter_source_param_ip_address <= rx_converter_sink_param_ip_address;
    rx_converter_source_param_length <= rx_converter_sink_param_length;
        ...
        1'd0: begin
            if ((~liteethudp_request[0])) begin
                if (liteethudp_request[1]) begin
                    ...
                    if (liteethudp_request[2]) begin
                        liteethudp_grant <= 2'd2;
                    end
                end
            end
        end
    ...
    if (liteethudp_status0_last) begin
        ...
        if ((internal_port_sink_valid & internal_port_sink_ready)) begin
    ...
    liteethudp_status2_ongoing1 <= liteethudp_status2_ongoing0;
    if (liteethudp_status2_last) begin
        liteethudp_status2_first <= 1'd1;
    end else begin
        if ((liteethudpstreamer1_internal_port_sink_valid & liteethudpstreamer1_internal_port_sink_ready)) begin
            liteethudp_status2_first <= 1'd0;
        end
    end
    if (liteethudp_first) begin
    ...
    if (sys_rst) begin
        ...
        ethphy__w_re <= 1'd0;
        ethphy__r_re <= 1'd0;
        mac_core_txdatapath_cdc_graycounter0_q <= 5'd0;
        mac_core_txdatapath_cdc_graycounter0_q_binary <= 5'd0;
        mac_core_preamble_errors_status <= 32'd0;
        mac_core_crc_errors_status <= 32'd0;
        mac_core_cdc_readable <= 1'd0;
        mac_core_cdc_graycounter1_q <= 5'd0;
        mac_core_cdc_graycounter1_q_binary <= 5'd0;
    ...
    multiregimpl20 <= mac_core_txdatapath_cdc_graycounter1_q;
    multiregimpl21 <= multiregimpl20;
    multiregimpl30 <= mac_core_pulsesynchronizer0_toggle_i;
    multiregimpl31 <= multiregimpl30;
    multiregimpl40 <= mac_core_pulsesynchronizer1_toggle_i;
    multiregimpl41 <= multiregimpl40;
    multiregimpl50 <= mac_core_cdc_graycounter0_q;
...
//------------------------------------------------------------------------------
// Memory storage: 16-words x 12-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: Sync | Mode: Read-First 
// Port 1 | Read: Sync  | Write: ---- | 
reg [11:0] storage[0:15];
...
//------------------------------------------------------------------------------
// Memory storage_2: 16-words x 12-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: Sync | Mode: Read-First 
// Port 1 | Read: Sync  | Write: ---- | 
reg [11:0] storage_2[0:15];
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2026-01-07 21:50:06.
//------------------------------------------------------------------------------
